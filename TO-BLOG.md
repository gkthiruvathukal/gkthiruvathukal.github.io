# TO-BLOG: Candidate Blog Postings

Working checklist of blog-post-worthy material, gathered from:
GitHub (`gkthiruvathukal`), Google Scholar, Loyola Phoenix, Loyola College
of Arts and Sciences, Wiley/CRC/Routledge/Taylor & Francis, and the Lab
for Applied AI. Cross-checked against the 18 posts already on the site
as of 2026-07-05 — only uncovered items are listed.

Priority order: **(1) well-cited papers > (2) mainstream/Loyola media
coverage > (3) everything else.**

## Priority 1 — Well-Cited & Uncovered

Ranked by Google Scholar citation count (profile total: 2,592 citations,
...
- [ ] **"A Survey of Software Metric Use in Research Software Development"** (2018) — 39 citations.
- [ ] **"Large-Scale Object Detection of Images from Network Cameras in Variable Ambient Lighting Conditions"** (2019) — 35 citations.
- [ ] **"Modular Neural Networks for Low-Power Image Classification on Embedded Devices"** (2020) — 33 citations.
- [ ] **"Essential Tools: Version Control Systems"** (2009) — 33 citations. Note: `src/drafts/blog_posts/gitting_good/` already has several unpublished draft posts on Git — this citation is a good hook to finally finish and publish that series.
- [ ] **"Efficient Computer Vision on Edge Devices with Pipeline-Parallel Hierarchical Neural Networks"** (2022) — 30 citations.

**Needs verification before using:** *"Efficient Encapsulation of Proteins in Submicro Liposomes Using a Supercritical Fluid Assisted Continuous Process"* (2016, 85 citations) — this is a biomedical/chemistry topic that doesn't match your CS research profile. Likely a Google Scholar name collision with a different "Thiruvathukal" — confirm authorship before considering it.
...
- [ ] **Lab for Applied AI** ([luc.edu/quinlan](https://www.luc.edu/quinlan/whyquinlan/centersandlabs/labforappliedartificialintelligence/)) — you're a member (steering/research committee); the lab page itself doesn't name you, but has adaptable framing text: NSF XTRIPODS-funded (award 2423235), "bridging the gap between theory and practice," ethical AI implementation, human-centric frameworks balancing productivity with worker autonomy. Good raw material for a post on your involvement and what the lab is doing, once you supply the specifics of your own contributions (not visible from the public page).
